...
const listax = document.getElementById('lista')
listax.appendChild(document.createElement('div'))
const mateuszx = listax.appendChild(document.createElement('div'))
mateuszx.innerHTML = 'Masz Gab'
console.log(mateuszx)